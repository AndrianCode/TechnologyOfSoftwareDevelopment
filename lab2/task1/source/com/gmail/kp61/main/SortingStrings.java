...
public class SortingStrings {
    public static void main(String[] args) {
        ...
        String dateOfAssignedTask = developer.assignTask(
                "Sort and output strings in order of increasing their length.");
        ...
        System.out.println("Date of receipt of the assignment:" +
                dateOfAssignedTask);
        System.out.println("End date of the assignment:" +
                developer.doneTask());
    }
}
